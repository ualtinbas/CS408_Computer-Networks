...
namespace server
{
    public partial class Form1 : Form
    {
        ...
        private void PrintBoard(List<int>userAnswers)
        {
            string prompt = "-------------------- \n";
            ...
            for (int i = 0; i < playerNames.Count(); i++)
            {
                prompt += playerNames[i]+"'s Answer" + ": " + userAnswers[i]+"\n";
            ...
            for (int i = 0; i < leaderboard_merged.Count(); i++)
            {
                ...
                prompt += leaderboard_merged[i].Value + "'s point: " + leaderboard_merged[i].Key + "\n";
            }
            prompt += "-------------------- \n";
